...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final String TAG = "nigol";
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.sign_in_button) {
            Log.i("onClick", "signIn onClick");
            signIn();
        } else if (i == R.id.send_button) {
            writeData();
        } else if (i == R.id.sign_out_button) {
            Log.i("onClick", "signOut onClick");
            signOut();
        }
    }
    ...
    private void writeData() {
        ...
        if (user != null) {
            ...
            Log.i(TAG, String.format("Name: %s, Email: %s, UID: %s", name, email, uid));
        }

        DatabaseReference mDatabase = FirebaseDatabase.getInstance().getReference();
        mDatabase.child("sessions").child("date1").setValue(46545);
